  ...
  <div class="modal-box">
    ...
    <div class="flex flex-auto justify-between p-1">
      <div class="relative m-1">
        <input bind:value={msg} type="text" class="rounded-full pl-6 pr-12 py-2 focus:outline-none
      ...
      <div class="w-8 h-8 rounded-full bg-blue-300 text-center items-center flex justify-center m-1">
        <button class="w-8 h-8 rounded-full text-center items-center flex justify-center focus:outline-none
                        hover:bg-gray-900 hover:text-white" on:click={sendmsg}>
